...
const Sidebar = () => {
  ...
  const { cart, clearCart, totalAmount, itemAmount } = useContext(CartContext);
  return (
     <div className={`${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
      ...
      <div className='flex items-center justify-between py-6 border-b'>
        ...
        {/* {icon} */}
        <div onClick={handleClose} className='cursor-pointer w-8 h-8 flex justify-center items-centerr'>
      ...
      <div className='flex bg flex-col gap-y-3 py-4 mt-4'>
